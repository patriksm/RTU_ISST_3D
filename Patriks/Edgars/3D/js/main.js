...
let map2 = [
    { posX: 700, posY: 200, posZ: 0, background: "#7c96ec", width: 200, height: 200, opacity: 1, name: "window" },
    { posX: 200, posY: 200, posZ: -100, background: "#4a0404", width: 250, height: 500, opacity: 1, name: "window" },
    { posX: 320, posY: 440, posZ: 100, background: "#000000", width: 10, height: 10, opacity: 1, name: "window" }
];
